...
{
	if cmd.light {
		warn!("Light client is deprecated and may be removed in a future release. Please see #XXXXX for details:\nhttps://github.com/openethereum/openethereum/issues/XXXXX");
